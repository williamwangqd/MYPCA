...
const (
	...
	// DownstreamAPIKeyHashMetadataKey stores a non-secret stable hash of the downstream client API key.
	DownstreamAPIKeyHashMetadataKey = "downstream_api_key_hash"
	// DownstreamAPIKeyIndexMetadataKey stores the downstream client API key's configured order when available.
	DownstreamAPIKeyIndexMetadataKey = "downstream_api_key_index"
)
