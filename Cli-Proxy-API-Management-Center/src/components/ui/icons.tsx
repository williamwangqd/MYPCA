/**
 * 本文件集中提供管理中心使用的离线 SVG 图标组件。
 * 所有图标沿用 Lucide 的线性视觉规范，并直接内嵌路径，确保 management.html 单文件部署时无需联网加载资源。
 * 本次补充文件夹打开图标，供“用户使用信息统计”页面直接打开每位使用人的本地日志目录。
 */
...
export function IconFolderOpen({ size = 20, ...props }: IconProps) {
  return (
    <svg {...baseSvgProps} width={size} height={size} {...props}>
      <path d="m6 14 1.5-2.9A2 2 0 0 1 9.3 10H20a2 2 0 0 1 1.8 2.9l-2.2 4.4A3 3 0 0 1 16.9 19H5a3 3 0 0 1-3-3V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.7.9l.8 1.2A2 2 0 0 0 12.1 6H18a2 2 0 0 1 2 2v2" />
    </svg>
  );
}
